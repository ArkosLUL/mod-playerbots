...
bool LootRollAction::Execute(Event /*event*/)
{
    ...
    for (Roll* const roll : rolls)
    {
        ...
        // Only vote on rolls the bot participates in and hasn't voted on yet. The find() guards the
        // key-missing case (bot not eligible / just logged in) safely via short-circuit.
