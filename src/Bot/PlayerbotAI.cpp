...
std::vector<std::string> const& PlayerbotAI::GetInstanceStrategies()
{
    static const std::vector<std::string> allInstanceStrategies =
    {
        ...
        "tbc-mech", "tbc-mgt", "tbc-seth", "tbc-ub", "tempestkeep", "trialofthecrusader", "ulduar",
        "voa", "wotlk-an", "wotlk-cos", "wotlk-dtk", "wotlk-eoe", "wotlk-fos", "wotlk-gd",
        "wotlk-hol", "wotlk-hos", "wotlk-nex", "wotlk-occ", "wotlk-ok", "wotlk-os", "wotlk-pos",
